      ...
      children: [
        ...
        LayoutBuilder(
          builder: (context, c) {
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(playlist.getAt(i).title),
                                  ),
                                  const SizedBox(width: 12),
                                  Text(
                                    playlist.getAt(i).artist,
                                    style: TextStyle(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ElevatedButton.icon(
                          onPressed: createIterator,
                          icon: const Icon(Icons.play_arrow),
                          label: const Text('Crear iterador'),
                        ),
                        ElevatedButton(
                          onPressed: next,
                    ...
                    if (current != null)
                      Container(
                        ...
                        child: Text(
                          'Reproduciendo: ${current!.title} · ${current!.artist}',
                        ),
                      )
                    else
                      Container(
                        ...
                        padding: const EdgeInsets.all(12),
                        child: Text(
                          lastMsg ?? 'Ningún elemento seleccionado',
            ...
            return Column(
              children: [playlistCard, const SizedBox(height: 12), controlCard],
            );
          },
        ),
      ],
