  ...
  return (
    <Box className="space-y-8" p="3">
      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-zinc-900 p-5">
          ...
          <figure>
            <img src="/img/real_prototype.png" alt="Prototype UML Diagram" className="w-full h-auto rounded-md border border-gray-100 dark:border-gray-700 shadow-sm" loading="lazy" />
          </figure>
        </div>
