...
class VisitorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PatternTemplate(
      ...
      badge: 'Behavioral',
      resumen:
          'Representa una operación a realizar sobre los elementos de una estructura sin cambiar las clases sobre las que opera.',
      problematicaGeneral:
          'Cuando operaciones distintas deben realizarse sobre una colección de objetos con clases heterogéneas y no quieres acoplar esas operaciones a las clases.',
      solucionGeneral:
          'Definir un Visitor con métodos visitX para cada tipo de elemento; cada elemento implementa accept(visitor).',
      casoEspecifico:
    ...
    diagramaSolucionEspecificaAssetPath: 'assets/diagrams/visitor.png',
      codeSnippets: const [
        CodeSnippet(
          title: 'element.dart',
          code: 'abstract class Element { void accept(Visitor v); }',
        ),
        CodeSnippet(
          title: 'visitor.dart',
          code:
              'abstract class Visitor { void visitBook(Book b); void visitElectronics(Electronics e); void visitGrocery(Grocery g); }',
        ),
      ],
      playground: const VisitorDemo(),
      playgroundExplicacion:
          'Agrega ítems al carrito y aplica operaciones: calcular totales, estimar envío o exportar CSV.',
    );
  }
}
