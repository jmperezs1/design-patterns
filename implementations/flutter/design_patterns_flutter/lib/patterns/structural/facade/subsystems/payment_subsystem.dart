class PaymentAuth {
  ...
  PaymentAuth({required this.txId, required this.amount, required this.currency});
}
...
class PaymentGateway {
  ...
  Future<PaymentAuth> authorize(Map<String, dynamic> payment) async {
    ...
    return PaymentAuth(txId: 'tx-${DateTime.now().millisecondsSinceEpoch}', amount: payment['amount'] as double, currency: payment['currency'] as String);
  }
