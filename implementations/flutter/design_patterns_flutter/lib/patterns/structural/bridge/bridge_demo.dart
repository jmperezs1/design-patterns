...
class _BridgeDemoState extends State<BridgeDemo> {
  ...
  Exporter _makeExporter() =>
      exporterKind == 'json' ? JsonExporter() : CsvExporter();
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Bridge Pattern: Reportes × Exportadores',
                style: Theme.of(
                  context,
