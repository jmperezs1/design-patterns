...
export const Implementation: StoryFn = () => {
	return (
		<Box className="space-y-8" p="3">
          ...
          <figure>
            <img src="/img/real_template.png" alt="Template UML Diagram" className="w-full h-auto rounded-md border border-gray-100 dark:border-gray-700 shadow-sm" loading="lazy" />
          ...
          <h5 className="text-sm font-semibold uppercase tracking-wide text-gray-500 mb-3">Diagrama UML</h5>
          <figure>
            <img src="/img/template.png" alt="Template UML Diagram" className="w-full h-auto rounded-md border border-gray-100 dark:border-gray-700 shadow-sm" loading="lazy" />
            <figcaption className="mt-2 text-[11px] text-gray-500 dark:text-gray-400 tracking-wide">Relación entre Director, Builder, ConcreteBuilder y Producto.</figcaption>
          </figure>
        </div>
