...
export const strategyCodeSnippets: CodeSnippet[] = [
  { title: 'strategy.ts', language: 'ts', code: `export interface PricingStrategy { getPrice(baseUnitPrice: number, quantity: number): number }
